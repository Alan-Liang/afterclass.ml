...
var SampleApp = function() {
    ...
    self.populateCache = function() {
        if (typeof self.zcache === "undefined") {
            self.zcache = { 'index.html': '' ,'login.html':'','link.html':''};
        }

        //  Local cache for static content.
        self.zcache['index.html'] = fs.readFileSync('./index.html');
        self.zcache['login.html'] = fs.readFileSync('./login.html');
        self.zcache['link.html'] = fs.readFileSync('./link.html');
    };
    ...
    self.createRoutes = function() {
        ...
        self.routes['/link'] = function(req, res) {
            res.setHeader('Content-Type', 'text/html');
            res.send(self.cache_get('link.html') );
        };
    };
